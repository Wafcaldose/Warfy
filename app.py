...
# Flex Message for Warfarin schedule
...
def handle_message(event):
    ...
    try:
        number = float(text)
        if number > 70:
            reply = "\u26a0\ufe0f \u0e02\u0e19\u0e32\u0e14\u0e22\u0e32\u0e40\u0e01\u0e34\u0e19 70 mg/สัปดาห์ \u0e42ปรดปรึกษาแพทย์"
        elif number < 7.0:
        ...
        reply = "โปรดพิมพ์เลขINR,ขนาดยาเดิม เช่น3.5,35"
